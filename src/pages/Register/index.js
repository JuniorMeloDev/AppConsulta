...
import { normalizePhoneNumber } from "../../components/MascaraTelefone";
import { formatCpf } from "../../components/MascaraCpf";
...
return (
    <div className="caixa-2">
        <form className="login-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <label>
                CPF:
                <input className="inputUser" type='text'{...register("cpf", { required: true })} />
                <span>{errors.cpf?.message}</span>
            </label>

            <label>
                Endereço:
                <input className="inputUser" {...register("adress", { required: true })} />
